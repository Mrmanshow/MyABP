                ...
                <Tabs value="detail">
                    <TabPane :label="L('UserDetails')" name="detail">
                        ...
                        <FormItem :label="L('ShowBeginDate')" prop="showBeginDate">
                            <DatePicker  type="date" @on-change="showBeginDate" format="yyyy-MM-dd" style="width:100%" placement="top-end" :placeholder="L('SelectDate')"></DatePicker>
                        </FormItem>
                        <FormItem :label="L('ShowEndDate')" prop="showEndDate">
                            <DatePicker  type="date" @on-change="showEndDate" format="yyyy-MM-dd" style="width:100%" placement="bottom-end" :placeholder="L('SelectDate')"></DatePicker>
                        </FormItem>
                    </TabPane>
                </Tabs>
            </Form>
